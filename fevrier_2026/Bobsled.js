...
Get Help
Tests
Waiting:1. checkEligibility([78], 165) should return "Eligible".
Waiting:2. checkEligibility([80], 160) should return "Not Eligible".
Waiting:3. checkEligibility([80], 170) should return "Not Eligible".
Waiting:4. checkEligibility([85, 90], 170) should return "Eligible".
Waiting:5. checkEligibility([85, 95], 168) should return "Not Eligible".
Waiting:6. checkEligibility([112, 97], 185) should return "Not Eligible".
Waiting:7. checkEligibility([110, 102, 90, 106], 222) should return "Eligible".
Waiting:8. checkEligibility([106, 99, 90, 88], 205) should return "Not Eligible".
Waiting:9. checkEligibility([106, 99, 103, 96], 227) should return "Not Eligible".
*/
...
function checkEligibility(athleteWeights, sledWeight) {
  let teamSize = athleteWeights.length();
  if(teamSize===1 & )
}